...
def create_app(config_class=Config):
    ...
    app.elasticsearch_url = 'http://localhost:9200'
    app.elasticsearch = Elasticsearch(app.elasticsearch_url) 
    ...
    from app.cli import bp as cli_pb
    app.register_blueprint(cli_pb)
